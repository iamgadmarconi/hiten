...
def save_center_manifold(
    ...
    *,
    ...
    """Serialise *cm* and (optionally) cached Hamiltonians.

    Parameters
    ----------
    include_hamiltonians
...
def load_center_manifold(dir_path: str | Path):
    """Return a reconstructed :class:`CenterManifold`."""
    from hiten.system.center import CenterManifold
