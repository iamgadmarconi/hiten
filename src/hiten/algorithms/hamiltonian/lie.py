...
- Lie series transformations via Poisson bracket iterations
- Polynomial canonical transformations in phase space
- Eigenvalue-based resonance handling for small divisors
